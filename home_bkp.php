...
?>
<table class='home' border='0' cellpadding="0" cellspacing="0">
<tr><td colspan='2'>
<h3>Herzlich Willkommen bei ETK AG</h3></td>
<tr><td width='300'>
<p>Der zweitbeste Moment uns herauszufordern ist jetzt.<br>
Der beste Moment ist vorbei.<br>
Wir freuen uns auf Ihre Herausforderung.<br><br></p>
<?PHP
echo "<img class='etkag' src='img.php?file=./fotos/mitarbeiter_lustig_500px.jpg&picWidth=300' border=0>";
?>
