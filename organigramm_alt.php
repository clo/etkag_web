...
<tr>
  <td class=orga>
  <?
    echo "<p class=pictext>Frank Kalbermatter:<br>Geschäftsführung<br>Kundenbetreuung</p>";
    echo "<a href='index.php?site=cv_frank&pos=".$_GET[pos]."&level=4' target='_top'><img src=".$picture_top['cv_frank']." border=0 width=150></a>"; 
  ?>
  </td>
  <td class=orga>
  <?
    echo "<p class=pictext>Jean Kalbermatter:<br>VR-Präsident<br>&nbsp;</p>";
...
<table border=0>
 <tr>
  ...
  <?
    ...
    echo "<p class=pictext>Infrastruktur für weiter 2-3 Monteuere:</p>";
  ?>  
  </td>
</tr>
</table>
